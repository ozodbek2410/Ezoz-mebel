...
export function OrdersPage({ companyName }: OrdersPageProps) {
  ...
  const statusConfig = {
    ...
    CONFIRMED: { label: "Tasdiqlangan", color: "text-emerald-600 bg-emerald-50", icon: Check },
    CANCELLED: { label: "Bekor qilingan", color: "text-red-500 bg-red-50", icon: XCircle },
  };
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4 mb-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="Buyurtma raqami kiriting"
