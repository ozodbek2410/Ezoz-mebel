      ...
      {PermissionGroups.map((group) => {
        ...
        return (
          <div key={group.title} className={`rounded-lg border overflow-hidden transition-colors ${
            allSelected ? "border-indigo-200" : someSelected ? "border-amber-200" : "border-slate-200"
          }`}>
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-3 py-2 transition-colors ${
                allSelected ? "bg-indigo-50 hover:bg-indigo-100" :
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className={`text-sm font-semibold ${
                  allSelected ? "text-indigo-700" : someSelected ? "text-amber-700" : "text-slate-700"
                }`}>
                  {t(group.title)}
                </span>
              </div>
